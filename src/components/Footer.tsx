        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">KSO</h3>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <a href="/about" className="text-gray-300 hover:text-red-400 transition-all duration-300 flex items-center group">
                  <span className="w-2 h-2 bg-red-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  About Us
                </a>
              </li>
              <li>
                <a href="/board" className="text-gray-300 hover:text-red-400 transition-all duration-300 flex items-center group">
                  <span className="w-2 h-2 bg-red-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Executive Board
                </a>
              </li>
              <li>
                <a href="/culture-show" className="text-gray-300 hover:text-red-400 transition-all duration-300 flex items-center group">
                  <span className="w-2 h-2 bg-red-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Culture Show
                </a>
              </li>
              <li>
                <a href="/shop" className="text-gray-300 hover:text-red-400 transition-all duration-300 flex items-center group">
                  <span className="w-2 h-2 bg-red-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  Shop
                </a>
              </li>
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
              ...
              <a
                ...
                className="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 space-y-2">
              ...
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span className="text-sm">Chicago, IL 60637</span>
              </div>
            </div>
          </div>
        </div>
