export type SocialBrand = 'instagram' | 'facebook' | 'linkedin' | 'email';
...
/** Recognizable brand marks (single-color, `currentColor`). */
export default function SocialBrandIcon({ brand, className = 'w-6 h-6' }: SocialBrandIconProps) {
  ...
  switch (brand) {
    ...
    case 'email':
      return (
        <svg className={cls} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
          <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5.99L4 8V6l8 6 8-6v2z" />
        </svg>
      );
    default:
      return null;
